        ...
        <div class="main-slider__items" data-main-slider>
            ...
            <div class="main-slider__item">
                ...
                <div class="main-slider__content">
                    ...
                    <div class="main-slider__brand">УАЗ Патриот</div>
                    <div class="main-slider__slogan">Покоряет по-новому</div>
                    <div class="btn btn--orange"><a href="">Покупайте от 764 900 ₽</a></div>
                </div>
        ...
        <div class="car-filter__wrp">
            ...
            <div class='car-filter__select'>
                ...
                <select id="select-brand" name="select-brand">
                    ...
                    <option value="b3">LADA</option>
                    <option value="b4">ГАЗ</option>
                </select>
            </div>
