...
<section class="section-about__top-photo">
        ...
        <div class="about__content container">
            ...
            <div class="about__text">Благодарим вас за интерес, проявленный к нашей компании</div>
        </div>
</section>
...
<section class="section-about-2 container">
    ...
    <div class="sa-col-2">
        ...
        <div class="content__text">
            <p>Он соответствует высоким стандартам качества и предоставляет нашим клиентам полный спектр услуг по
                ремонту и техническому обслуживанию автомобилей.</p>
            <p>Строгое соблюдение технологии ремонта, выполнение рекомендаций завода-изготовителя, современное
                диагностическое/ремонтное оборудование и высокий профессионализм персонала гарантируют качество ремонта
                и обслуживания Вашего автомобиля.</p>
        </div>
...
<section class="certificate-slider">
        ...
        <div class="slider__wrapper" data-slider-certificates>
            ...
            <div class="slider-btn-wrp slider-btn-wrp--certificate">
                <span class="slider-btn slider-btn--prev" data-prev></span>
                <span class="slider-btn slider-btn--next" data-next></span>
            </div>


            <div class="certificate__items slider-items-wrp">

                <div class="certificate__item-wrp slide-item">
                    <div class="certificate__item">
                        <a class="certificate__img" data-fancybox-img href="img/certificates_01_big.jpg">
                            <img src="img/certificates_01_small.jpg" alt="Сертификаты">
                        </a>
                        <span class="certificate__title">День Поля 2014</span>
                    </div>
                </div>
                ...
                <div class="certificate__item-wrp slide-item">
                    <div class="certificate__item">
                        <a class="certificate__img" data-fancybox-img href="img/certificates_02_big.jpg">
                            <img src="img/certificates_02_small.jpg" alt="Сертификаты">
                        </a>
                        <span class="certificate__title">УАЗ Сертификат</span>
                    </div>
                </div>
                ...
                <div class="certificate__item-wrp slide-item">
                    <div class="certificate__item">
                        <a class="certificate__img" data-fancybox-img href="img/certificates_03_big.jpg">
                            <img src="img/certificates_03_small.jpg" alt="Сертификаты">
                        </a>
                        <span class="certificate__title">Благотворительный марафон «Ты нам нужен»</span>
                    </div>
                </div>
                ...
                <div class="certificate__item-wrp slide-item">
                    <div class="certificate__item">
                        <a class="certificate__img" data-fancybox-img href="img/certificates_04_big.jpg">
                            <img src="img/certificates_04_small.jpg" alt="Сертификаты">
                        </a>
                        <span class="certificate__title">Сбербанк</span>
                    </div>
                </div>
                ...
                <div class="certificate__item-wrp slide-item">
                    <div class="certificate__item">
                        <a class="certificate__img" data-fancybox-img href="img/certificates_05_big.jpg">
                            <img src="img/certificates_05_small.jpg" alt="Сертификаты">
                        </a>
                        <span class="certificate__title">Сбербанк Сбербанк</span>
                    </div>
                </div>
